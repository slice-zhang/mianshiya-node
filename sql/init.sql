...
create table if not exists user (
    ...
    user_profile varchar(255) null comment '用户描述',
    ...
    invite_user bigint null comment '邀请人id',
    user_role int default 1 not null comment '用户角色 1 普通用户 2 管理员 3 封禁',
    created_at datetime default current_timestamp not null comment '创建时间',
    updated_at datetime default current_timestamp not null comment '更新时间',
    deleted_at datetime comment '是否删除'
...
create table if not exists question_bank (
    ...
    user_id bigint not null comment '创建的用户id',
    adult_status int default 1 not null comment '审核状态 1 待审核 2 审核成功 3 审核失败',
    priority int default 0 not null comment '排序',
    view_num int default 0 null comment '浏览量',
    created_at datetime default current_timestamp not null comment '创建时间',
    updated_at datetime default current_timestamp not null comment '更新时间',
    deleted_at datetime comment '是否删除',
    index idx_title (title)
    ) comment '题库表' collate = utf8_general_ci;
...
(
    ...
    priority int default 0 not null comment '排序',
    view_num int default 0 null comment '浏览量',
    thumb_num int default 0 null comment '点赞量',
    favour_num int default 0 null comment '收藏量',
    need_vip tinyint default 1 null comment '是否需要vip查看 1 不需要 2 需要',
    user_id     bigint                             not null comment '创建用户 id',
    created_at datetime default CURRENT_TIMESTAMP not null comment '创建时间',
    updated_at datetime default CURRENT_TIMESTAMP not null on update CURRENT_TIMESTAMP comment '更新时间',
    deleted_at datetime comment '是否删除',
    difficulty tinyint not null default 1 comment '难度 1 普通 2 中等 3困难',
    index idx_title (title),
...
create table if not exists question_bank_adult_log(
    id bigint auto_increment primary key not null comment 'id',
    question_bank_id bigint not null comment '题库id',
    adult_status tinyint not null comment '审核状态 1 待审核 2 审核通过 3 审核不通过',
    user_id bigint not null comment '审核人',
    remark varchar(255) null comment '审核原因',
    created_at     datetime default CURRENT_TIMESTAMP not null comment '创建时间',
    updated_at     datetime default CURRENT_TIMESTAMP not null on update CURRENT_TIMESTAMP comment '更新时间'
) collate = utf8_general_ci comment '题库审核日志表';

create table if not exists question_adult_log(
    id bigint auto_increment primary key not null comment 'id',
    ...
    created_at     datetime default CURRENT_TIMESTAMP not null comment '创建时间',
    updated_at     datetime default CURRENT_TIMESTAMP not null on update CURRENT_TIMESTAMP comment '更新时间'
) collate = utf8_general_ci comment '题目审核日志表';
...
insert into question_adult_log (question_id, adult_status, user_id, remark) values
(1,2,1,''),
(2,2,1,''),
(3,2,1,''),
(4,2,1,''),
...
insert into question_bank_adult_log (question_id, adult_status, user_id, remark) values
(1,2,1,''),
(2,2,1,''),
(3,2,1,''),
(4,2,1,''),
